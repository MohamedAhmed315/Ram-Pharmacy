...
@Component({
  selector: 'app-top-purchased',
  standalone: true,
  imports: [NgxSplideModule, ProductCardComponent],
  templateUrl: './top-purchased.component.html',
  styleUrl: './top-purchased.component.scss'
})
export class TopPurchasedComponent {
  @Output() products = [{
